...
static struct node *parse(); /* extern struct node *parse(); */
static struct node *plist(); /* extern struct node *plist(); */
static struct node *pstring(); /* extern struct node *pstring(); */
static struct node *pnumber(); /* extern struct node *pnumber(); */
static struct node *pquote(); /* extern struct node *pquote(); */
static struct node *pname(); /* extern struct node *pname(); */
