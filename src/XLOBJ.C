...
static struct node *findmsg(); /* extern struct node *findmsg(); */
static struct node *findvar(); /* extern struct node *findvar(); */
static struct node *defvars(); /* extern struct node *defvars(); */
static struct node *makelist(); /* extern struct node *makelist(); */
